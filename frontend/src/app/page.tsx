      ...
      <section className='overflow-hidden rounded-3xl border border-brand-cornflower/20 bg-gradient-to-br from-white via-white to-brand-cornflower/10 p-5 shadow-soft'>
        <div className='grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(360px,460px)] xl:items-start'>
          <div className='min-w-0 max-w-4xl'>
            ...
            <h1 className='mt-3 text-3xl font-bold tracking-tight text-brand-navy lg:text-4xl xl:mt-24'>Day90 Guardian Command Center</h1>
          ...
          <div className='flex w-full min-w-0 flex-col gap-3 xl:max-w-[460px] xl:justify-self-end'>
            <div className='rounded-2xl border border-white/70 bg-white/70 p-3 shadow-sm backdrop-blur'>
              <Button variant='gradient' className='h-12 w-full justify-center rounded-2xl text-sm font-semibold whitespace-nowrap' onClick={triggerRun} disabled={isTriggering}>
