...
const mockNotifications: Notification[] = [
  {
    id: '1',
    type: 'success',
    title: 'Day90 Run Prepared',
    message: 'Dashboard, Workbench, policies, and insights are available.',
  ...
  },
  {
    id: '2',
    type: 'info',
    title: 'Workbench Queue Ready',
    message: 'Amber, Red, and Confidential review paths are visible.',
  ...
  },
  {
    id: '3',
    type: 'warning',
    title: 'Supabase Key Needed',
    message: 'Add backend Supabase credentials before final live data proof.',
