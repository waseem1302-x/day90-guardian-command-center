...
AUTH_BYPASS_REQUESTED = os.getenv("AUTH_BYPASS", "false").lower() == "true"
...
if AUTH_BYPASS_REQUESTED and not AUTH_BYPASS:
    log.error("AUTH_BYPASS was requested but disabled because APP_ENV=%s", APP_ENV)
elif AUTH_BYPASS:
